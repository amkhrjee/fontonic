...
<div align="center" style="display: flex; justify-content:center; gap: 2rem;"><img src="./screenshots/mobile_one.png" style="height: 50%; width: 50%"><img src="./screenshots/mobile_two.png" style="height: 50%; width: 50%"></div><br>
